      ...
      for line in file_reader:
          ...
          if line[5] != '':
              if line[1] == '1':
                  ...
                  if float(line[5]) > 60:
                      unsurv60 += 1
  choice1 = st.radio("Поиск пассажиров среди:", ["спасенных", "погибших"])
  choice2 = st.radio("Поиск в возрастной группе:", ["до 30 лет", "старше 60 лет"])
  if choice1=='спасенных':
      if choice2=='до 30 лет':
