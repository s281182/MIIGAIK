...
st.markdown("Вариант1: Выводит долю пассажиров среди погибших или выживших в в возрастных группах «до 30 лет» или «старше 60». (Автор Горелкин А.)●●"
            "Вариант2: Выводит долю выживших среди пассажиров указанного пола. (Автор Гочияева Л.)\n"
            "Вариант3: Выводит классы билетов, имена и возраст спасенных пассажиров с указанными именами. (Автор Исмагиловна Э.)\n"
